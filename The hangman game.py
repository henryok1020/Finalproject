...
print("\t1. Beginner (15 lives)")
print("\t2. Intermediate (10 lives)")
print("\t3. Expert (8 lives)")
print("\t4. Advanced (5 lives)")
print("\t5. Insane (3 lives)")
...
with open("/Users/henry/Desktop/python/myGuessWords.txt") as f:
